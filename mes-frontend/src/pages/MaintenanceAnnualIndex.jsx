...
export function MaintenanceAnnualIndex({ fy, onBack }) {
  ...
  // load on open / FY change / page refresh — no auto-poll.
  useEffect(() => { load(); }, [load]);
  ...
  return (
    <div className="ix-root">
      <style>{`
        ...
        .ix-sec { font-weight:800; font-size:14px; color:#fff; background:#334155; padding:7px 12px; border-radius:6px 6px 0 0; margin-top:22px; text-align:center; }
