...
import { OjtForm, ojtBlank, ojtRow } from "./skill/OjtForm";
...
/* Form ka markup + uska CSS ab `skill/OjtForm.jsx` me hai -- wahi form CAPA me
   bhi juda jaata hai (user 2026-09-20), isliye EK hi jagah. */
const emptyRow = ojtRow;
const emptyForm = () => ({ id: null, ...ojtBlank() });
...
export default function OJT() {
  ...
  // form ke andar kuch bhi badla -- `OjtForm` poora naya value deta hai
  const onForm = (v) => { setForm((f) => ({ ...f, ...v })); setDirty(true); };
  ...
  return (
    <>
      <style>{`
        ...
        /* Form ka card / table / foot wala CSS ab skill/OjtForm.jsx me hai
           (wahi form CAPA me bhi lagta hai) -- yahan sirf page ka CSS.
           DHYAN: is string me backtick mat likhna, wo string hi tod deta hai. */
            ...
            <div className="oj-panel" style={{ padding: 18 }}>
              <OjtForm
                ...
                actions={<>
                  ...
                  <button className="oj-btn oj-btn-save" onClick={save} disabled={saving || !dirty}>
