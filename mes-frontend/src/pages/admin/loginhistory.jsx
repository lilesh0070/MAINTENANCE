/* admin/loginhistory.jsx — "Login History" tab (Maintenance Panel, User & Access ke aage).
   Kisne kab login kiya, kab logout — maintenance_audit_log ke AUTH_LOGIN/AUTH_LOGOUT se.
   Backend: GET /api/audit/logins (har login ko agle logout se pair karta hai).
   Filters: Financial Year · Month · Date · User — default current FY/month/date. */
        ...
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            ...
            <tbody>
              ...
              {!loading && !rows.length && (
                <tr><td colSpan={6} style={{ padding: "22px 14px", color: "#94a3b8", textAlign: "center" }}>Is range me koi login record nahi.</td></tr>
              )}
              {loading && (
                <tr><td colSpan={6} style={{ padding: "22px 14px", color: "#94a3b8", textAlign: "center" }}>Loading…</td></tr>
              )}
            </tbody>
          </table>
        </div>
